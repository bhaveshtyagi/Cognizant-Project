...
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(1,1); } </script>
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="Admin.jsp"><span class="fa fa-user"></span>   Admin<span class="dashboard_text">Dasboard</span></a></h1>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                <a href="#">
                <i class="fa fa-user"></i> <span>Applied Users</span>
                <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li><a href="AppliedUsersTable.jsp"><i class="fa fa-angle-right"></i>All Users List</a></li>
                </ul>
              </li>
             
          
              <li class="header">EXTRAS</li>
              <li><a href="#"><i class="fa fa-angle-right text-red"></i> <span>EMPTY TAB1</span></a></li>
              <li><a href="#"><i class="fa fa-angle-right text-yellow"></i> <span>EMPTY TAB2</span></a></li>
              <li><a href="#"><i class="fa fa-angle-right text-aqua"></i> <span>EMPTY TAB3</span></a></li>
            </ul>
          </div>
          <!-- /.navbar-collapse -->
      </nav>
